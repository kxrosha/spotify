...
urlpatterns = [
    ...
    path('retrieve/<int:id>/', views.DestroyDetailUpdateUserView.as_view(), name='user_retrieve'),
    path('update/<int:id>/', views.DestroyDetailUpdateUserView.as_view(), name='user_update'),
    path('delete/<int:id>/', views.DestroyDetailUpdateUserView.as_view(), name='user_delete'),
